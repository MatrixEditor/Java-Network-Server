...
/**
 * SampleClientChannel in main (Java-Network-Server)
 * <p>
 * Class description...
 *
 * @author
 ...
 * @date 26.11.2020
 **/
public class SampleClientChannel extends ChannelHandlerAdapter<SocketStream> {
    ...
    public SampleClientChannel(Channel<SocketStream> channel) {
        super(channel);
    ...
    SampleClientChannel add(C channel) {
    ...
    @Override
    public <C extends ChannelWorker<SocketStream>>
    SampleClientChannel addFirst(C channel) {
    ...
    @Override
    public SampleClientChannel input() {
    ...
    @Override
    public SampleClientChannel open() {
